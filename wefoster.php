<?php
/*
Plugin Name: Migrate To WeFoster
Plugin URI: https://wefoster.co
Description: The easiest way to migrate your site to WeFoster
Author: WeFoster
Author URI: https://wefoster.co
Version: 1.88
Network: True
 */

/*  Copyright 2017  WeFoster Migration  (email : support@blogvault.net)
...
register_uninstall_hook(__FILE__, array('WeFoster', 'uninstall'));
...
if (is_admin()) {
	...
	##ACTIVATEWARNING##
	add_action('admin_enqueue_scripts', array($bvadmin, 'wefsecAdminMenu'));
}
